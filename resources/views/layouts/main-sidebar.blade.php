				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='Invoice_Partial') }}">الفواتير المدفوع جزئياً</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='InvoiceArchive') }}">أرشفة الفواتيرً</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='InvoiceArchive') }}">أرشفة الفواتيرً</a></li>
						</ul>
					</li>
					...
					<li class="side-item side-item-category">المسخدمين</li>
					<li class="slide">
